package com.binzikeji.hello.yanzhengma.utils;
...
public class TCaptchaVerify {
    private static final String APP_ID = "2048449315";
    private static final String APP_SECRET = "0kd6hoNP-0SOCEpsItomhIg**";
